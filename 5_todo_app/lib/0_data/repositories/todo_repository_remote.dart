...
class ToDoRepositoryRemote with ToDoCollectionMapper, ToDoEntryMapper implements ToDoRepository {
  final ToDoRemoteDataSourceInterface remoteSource;

  ToDoRepositoryRemote({required this.remoteSource});

  String get userId => FirebaseAuth.instance.currentUser?.uid ?? 'some-user-id-123';
